...
import { BaseRenderTexture, Texture } from 'pixi.js';
import { getRunnerApp } from '../runnerApp';

let shadowTexture: BaseRenderTexture;
...
export function getBlobShadow(renderer: PIXI.Renderer) {
    ...
    if (!shadowTexture) {
        ...
        shadow.destroy();
        shadowTexture = texture.baseTexture;
    }


    const realShadow = new PIXI.Sprite(new Texture(shadowTexture));
