...
const context = createDemoContext(
    ...
    [],
    {
        async initScence(context) {
            ...
            const item = enemyAnimateMap.succubus_idle as AnimatedSprite;
            ...
            newAnimate.play();
            newAnimate.position.set(1500, 500);
            ...
            framework.beginFill(0xffffff)
                ...
                .endFill();
            framework.position.set(1500, 500);
