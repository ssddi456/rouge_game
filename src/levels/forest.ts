...
export class ForestLevel implements Level {
    ...
    blockContext: { update(x: number, y: number): void } | undefined = undefined;
    ...
    constructor(
        ...
        public resources: Record<string, Record<string, AnimatedSprite>>
    ) {}
    ...
    init(gameView: Viewport) {
        ...
        const playerAnimateMap = this.resources.playerAnimateMap;
        const bowAnimateMap = this.resources.bowAnimateMap;
        const gunAnimateMap = this.resources.gunAnimateMap;
        const enemyAnimateMap = this.resources.enemyAnimateMap;
        const treeAnimateMap = this.resources.treeAnimateMap;
        const hitEffect = this.resources.hitEffect;
        const resources = this.resources.resources;
